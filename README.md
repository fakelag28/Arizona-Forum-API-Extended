### Данная синхронная библиотека более не будет обновляться, все изменения будут выходить только в [асинхронной версии](https://github.com/fakelag28/Arizona-Forum-API-Async).
